...
# create users
user1 = User.create(username: "John", email: "john@example.com", password: "$2a$12$457wUfgvrN1HeXZjQRT4pes5mEIZAAhrBP9PuEm9pjieD8aQnpIWq")
# user2 = User.create(username: "Jane", email: "jane@example.com")
# create cars
